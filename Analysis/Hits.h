...
Bool_t Hits::HitDet(Int_t hit){
  ...
  if     (hit==1)
    return p1[moduleID].Z() < (detThick + 50.);
  else if(hit==2)
    return p2[moduleID].Z() < (detThick + 50.);
  else 
    return false;
}
...
void Hits::FinalStats(){
  ...
  cout <<  endl;
  cout << "  Good PET   = " << fracPET      <<  endl; 
  cout << "  Good QET   = " << fracQET      <<  endl; 
  cout << "  edep < 511 = " << fracE_LT_511 <<  endl; 
  cout <<  endl;
  cout << " --------------------------------------- "   <<  endl;
  cout << " --------------------------------------- "   <<  endl;
}
